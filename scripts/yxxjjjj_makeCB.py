...
for  sigmean in sigmeans:
  for alphaBin, alpha in enumerate(alphaBins):
    ...
    outfileName = pCBt.prepareCBTemplate(indir = "/afs/cern.ch/work/j/jroloff/nixon/signalMorphing/systs/", histName = histName, doSysts = True, mY = sigmean, alpha = alpha, outfile = "templates/systematics", pruneThreshold = 0.05, systematicNameFile = systematicNameFile)
