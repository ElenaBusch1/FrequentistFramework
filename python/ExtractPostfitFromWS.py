...
def main(args):
    ...
    parser.add_argument('--wsfile', dest='wsfile', type=str, default='../run/FitResult_mean500_width7.root', help='Workspace file name')
...
#    parser.add_argument('--outfile', dest='outfile', type=str, default='../run/', help='Output file name')
...
#    w.Print("all")
    ...
    for i in range(nChan):
        ...
        fout = ROOT.TFile("postfit_%s.root" % channelname, "RECREATE")
